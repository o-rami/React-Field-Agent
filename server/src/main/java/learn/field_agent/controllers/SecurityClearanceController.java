...
public class SecurityClearanceController {
    ...
    public SecurityClearanceController(SecurityClearanceService service) {
        this.securityClearanceService = service;
    }
    ...
    public ResponseEntity<Object> update(@PathVariable int securityClearanceId,
                                         @RequestBody SecurityClearance securityClearance) {
